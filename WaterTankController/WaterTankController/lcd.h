...
/**
 * @brief    Sets cursor to specified position and puts string on LCD
 *
 * Using functions lcd_gotoxy and lcd_puts
 * @param    x horizontal position\n (0: left most position)
 * @param    y vertical position\n (0: first line)
 * @param    s string to be displayed
 * @return   none
 */
extern void lcd_show(uint8_t x, uint8_t y, const char *s);

/**
 * @brief    Set cursor to specified position and puts character on LCD
 *
 * Using functions lcd_gotoxy and lcd_putc
 * @param    x horizontal position\n (0: left most position)
 * @param    y vertical position\n (0: first line)
 * @param    c char to be displayed
 * @return   none
 */
extern void lcd_showc(uint8_t x, uint8_t y, char c);
