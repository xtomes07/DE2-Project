...
#### Další možná rozšíření:
 Další rozšíření by mohlo být menu pro uživatelsky přívětivější nastavení velikosti nádrže a maximální výšky hladiny vody v nádrži. Jako další by bylo možné připojit další periferie jako je například další čerpadlo pro čerpání vody z nádrže třeba do zavlažovacího systému a čidlo vlhkosti pro závlahu. Pomocí komunikace přes WIFI nebo Bluetooth modul by bylo možné vytvořit mobilní aplikace pro ovladání a výpis informací o stavu nádrže.

<a name="video"></a>

## Video

https://www.youtube.com/watch?v=FyWZg4yU_cU

<a name="references"></a>

## References

1. Přednášky a laboratorní cvičení z DE2
2. Datasheety k hardwaru
